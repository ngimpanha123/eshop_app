...
class CashierSalesView extends GetView<CashierSalesController> {
  const CashierSalesView({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.access_time, size: 16, color: ThemeConfig.textSecondary),
                  const SizedBox(width: 4),
                  Text(
                    controller.formatDate(sale.orderedAt),
                    style: TextStyle(fontSize: 13, color: ThemeConfig.textSecondary),
                  ),
                  const Spacer(),
                  Text(
                            ...
                            child: Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                return Container(
                                  ...
                                  child: Icon(Icons.image, color: ThemeConfig.textTertiary),
                                );
                              },
                            ),
                          ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () async {
                        final pdf = await controller.getOrderInvoice(sale.receiptNumber);
                        if (pdf != null) {
